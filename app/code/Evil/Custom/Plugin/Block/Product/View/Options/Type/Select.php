...
class Select
{
            ...
            foreach ($_option->getValues() as $_value) {
               /* $priceStr = $subject->_formatPrice(
                    [
                        ...
                        'pricing_value' => $_value->getPrice(), //                        'pricing_value' => $_value->getPrice($_value->getPriceType() == 'percent'),
        ...
        if ($_option->getType() == \Magento\Catalog\Model\Product\Option::OPTION_TYPE_RADIO ||
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                if ($arraySign) {
                    ...
                    if($count == 2){ $check = 'checked="checked"'; }else { $check = ''; }
                $selectHtml .=  '<div class="field choice admin__field admin__field-option' .
                    ...
                    '" ' .
                    $checked .
                    ' data-selector="' . $dataSelector . '"' .$check.
                    ' price="' .
    ...
    {
        return ($this->hasSwatch() === true) ? '<div class="swatch" > <img src="' . $this->mediaUrl . $this->customOptionValues[Label::CTM_SWATCH] . '" class="swatch-image" /></div>' : '';
    }
