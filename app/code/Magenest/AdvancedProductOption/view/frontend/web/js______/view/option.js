...
define([
    ...
    'uiComponent',
     'priceBox',
    'ko'
], function (jquery,Component,pricebox,ko) {
    'use strict';
...
jquery('#advanced_custom_option_price_cal').val(row.price());                           
    ...
    function Row(data) {
        ...
        this.calculatePrice = function() {
            ...
            console.log(this.model.selectedOptions());
            ko.utils.arrayForEach(this.model.selectedOptions(), function(option) {
                if (option != undefined)
      ...
      /*  initialize: function () {
        ...
        initObservable: function () {
            ...
            self.isLoading.subscribe(function (newValue) {
                if (!newValue) {
                  jquery('.advanced-product-option').css('display','block');

                  jquery('span[data-role="apo-spinner"]').hide();
                }
            } );
