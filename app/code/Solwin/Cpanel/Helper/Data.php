...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    public function getshipping1() {
        return $this->scopeConfig->getValue('cpanelsection/homepagegroup/shipping1', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }   
	/* Get show store contactno */

    public function getshipping2() {
        return $this->scopeConfig->getValue('cpanelsection/homepagegroup/shipping2', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }   
	/* Get show store contactno */

    public function getshipping3() {
        return $this->scopeConfig->getValue('cpanelsection/homepagegroup/shipping13', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }    
	/* Get show store contactno */

    public function getfirstblock() {
        return $this->scopeConfig->getValue('cpanelsection/homepagegroup/firstblock', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }   
	/* Get show store contactno */

    public function getfirstblock_link() {
        return $this->scopeConfig->getValue('cpanelsection/homepagegroup/firstblock_link', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }    
	/* Get show store contactno */

    public function getsecondblock() {
        return $this->scopeConfig->getValue('cpanelsection/homepagegroup/secondblock', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }   
	/* Get show store contactno */

    public function getsecondblock_link() {
        return $this->scopeConfig->getValue('cpanelsection/homepagegroup/secondblock_link', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
